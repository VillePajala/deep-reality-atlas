/**
 * Alternative gallery catalogue — second plate set.
 * Mirrors the shape of /gallery so the two can sit side-by-side for A/B review.
 * Pages are sequenced so the gallery reads as a walk through one atlas,
 * page 7 → page 217.
 */
...
export const galleryImages: GalleryImage[] = [
  {
    src: '/gallery-2/007-tendril-taxonomy.png',
    plate: 'PAGE 007',
  ...
  {
    src: '/gallery-2/008-foam-index.png',
    plate: 'PAGE 008',
  ...
  {
    src: '/gallery-2/012-glyph-that-grew-a-body.png',
    plate: 'PAGE 012',
  ...
  {
    src: '/gallery-2/029-ink-tide.png',
    plate: 'PAGE 029',
    title: 'The ink-tide',
    descriptor:
  ...
  {
    src: '/gallery-2/031-central-absence.png',
    plate: 'PAGE 031',
  ...
  {
    src: '/gallery-2/047-inventory-of-the-site.png',
    plate: 'PAGE 047',
  ...
  {
    src: '/gallery-2/063-downpour.png',
    plate: 'PAGE 063',
    title: 'The downpour',
    descriptor:
  ...
  {
    src: '/gallery-2/071-cellular-coast.png',
    plate: 'PAGE 071',
  ...
  {
    src: '/gallery-2/088-wall-of-the-archive.png',
    plate: 'PAGE 088',
  ...
  {
    src: '/gallery-2/094-thing-that-watched-back.png',
    plate: 'PAGE 094',
  ...
  {
    src: '/gallery-2/101-void-has-a-body.png',
    plate: 'PAGE 101',
  ...
  {
    src: '/gallery-2/119-cell-atlas.png',
    plate: 'PAGE 119',
  ...
  {
    src: '/gallery-2/127-apparatus-breathing.png',
    plate: 'PAGE 127',
  ...
  {
    src: '/gallery-2/142-column-that-became-weather.png',
    plate: 'PAGE 142',
  ...
  {
    src: '/gallery-2/143-eye-that-reads-back.png',
    plate: 'PAGE 143',
  ...
  {
    src: '/gallery-2/217-thinking-web.png',
    plate: 'PAGE 217',
