  ...
  return (
    <main className="flex flex-col items-center min-h-screen px-6 py-16">
      ...
      <article className="max-w-xl space-y-6 text-sm leading-7 text-neutral-400">
        ...
        {/* Section: Cartography of Invisible Systems */}
        <h2 className="text-xs tracking-[0.3em] text-neutral-500 uppercase pt-8">
        ...
        {/* Section: The Dissolution of Consensus Reality */}
        <h2 className="text-xs tracking-[0.3em] text-neutral-500 uppercase pt-8">
        ...
        {/* Section: The Lineage of the Seeker */}
        <h2 className="text-xs tracking-[0.3em] text-neutral-500 uppercase pt-8">
        ...
        {/* Section: Time and Eternal Return */}
        <h2 className="text-xs tracking-[0.3em] text-neutral-500 uppercase pt-8">
      ...
      {/* Enter the Atlas */}
      <nav className="mt-20 flex flex-col items-center gap-4">
        <Link
          href="/atlas"
          className="px-8 py-3 border border-neutral-800 hover:border-neutral-500
