 ...
 * Gallery catalogue.
 *
 * V.P.'s note: Descriptors below are my readings of the plates, not
 * Kamikaze's captions. The quoted passages are Kamikaze's own, drawn
 * from the journal where a thematic pairing seemed unmistakable.
 * Attributions are deliberately vague — the archive has no reliable
 * catalogue and I have not invented one.
 *
 * Five plates are paired to specific journal entries; for those the
 * quote renders as a link to the entry's permalink page.
 */
...
export interface GalleryImage {
  ...
  plate: string;
  title: string;
  descriptor: string;         // V.P.'s editorial reading of the plate
